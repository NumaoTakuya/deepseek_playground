...
- **JSON Output** and **Tool Calls** support
- **Chat Prefix Completion (Beta)** and **FIM Completion (Beta)**
- **Tokenizer-backed token usage** and **API cost estimates**
- **Code view popup** to reproduce thread API calls
...
- Implemented **Chat Prefix Completion (Beta)** and **FIM Completion (Beta)**
- Launched **tokenizer service on GCP** for cumulative token counts and API cost estimation
- Added a **code-view popup** to reproduce a thread's API calls
- Updated **model max tokens** to the latest values
- Minor UI and persistence fixes
